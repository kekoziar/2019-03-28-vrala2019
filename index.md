...
venue: "DoubleTree by Hilton Los Angeles Downtown"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Noah Geraci ", "Katherine Koziar"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
